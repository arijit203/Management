...
const AddUserForm = ({ onAddUser }) => {
    ...
    return (
      ...
      <div className="rounded-lg border bg-card text-card-foreground shadow-sm bg-white w-3/5" data-v0-t="card">
        <div className=" items-center p-6">
            <h3 className="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Add User</h3>
            <p class="text-sm text-muted-foreground">Fill out the form to add a new user to the system.</p>        
      </div>
